...
/// In this [VehiclesDealingChallenge] class, [httpClient] is the only necessary component
...
class VehiclesDealingChallenge {
  VehiclesDealingChallenge._();
  ...
  ///
  /// ```dart
  /// final headers = {VehiclesDealingChallenge.user: someUserId};
  /// ```
  ...
  ///
  /// ```dart
  /// if (input.length == VehiclesDealingChallenge.vinLength) return isValid = true;
  /// ```
  ...
  ///   // ...
  ///   final response = await VehiclesDealingChallenge.httpClient
  ///       .get(Uri.https('anyUrl'), headers: {VehiclesDealingChallenge.user: someUserId});
  ///   // ...
  /// }
  /// ```
...
Future<void> main() async {
  final response = await VehiclesDealingChallenge.httpClient.get(
      Uri.https('anyUrl'),
      headers: {VehiclesDealingChallenge.user: 'someUserId'});
