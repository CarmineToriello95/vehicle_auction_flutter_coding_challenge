...
/// In this [VehicleAuctionChallenge] class, [httpClient] is the only necessary component
...
class VehicleAuctionChallenge {
  VehicleAuctionChallenge._();
  ...
  ///
  /// ```dart
  /// final headers = {VehicleAuctionChallenge.user: someUserId};
  /// ```
  ...
  ///
  /// ```dart
  /// if (input.length == VehicleAuctionChallenge.vinLength) return isValid = true;
  /// ```
  ...
  ///   // ...
  ///   final response = await VehicleAuctionChallenge.httpClient
  ///       .get(Uri.https('anyUrl'), headers: {VehicleAuctionChallenge.user: someUserId});
  ///   // ...
  /// }
  /// ```
...
Future<void> main() async {
  final response = await VehicleAuctionChallenge.httpClient.get(
      Uri.https('anyUrl'),
      headers: {VehicleAuctionChallenge.user: 'someUserId'});
